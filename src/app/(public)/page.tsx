...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow bg-[#F9F7FC]">
        <div className="p-8 space-y-8 max-w-[1600px] mx-auto -mt-12 md:-mt-12 relative z-20">
          <div className="bg-white rounded-[2rem] shadow-xl p-8 border border-brand-lilac/5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
              ...
              <motion.div 
                ...
                className="lg:col-span-2 bg-slate-50 border border-slate-200 p-6 rounded-3xl"
              >
